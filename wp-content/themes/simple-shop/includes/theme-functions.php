		...
		<div class="sds-sitemap sitemap">
			<?php if ( apply_filters( 'sds_sitemap_show_pages', true ) ) : // Allow pages to not be displayed ?>
				<div class="sitemap-pages page-list">
					<h2 title="<?php esc_attr_e( 'Pages', 'simple-shop' ); ?>"><?php _e( 'Pages', 'simple-shop' ); ?></h2>
					<ul>
			...
			<?php if ( apply_filters( 'sds_sitemap_show_monthly_archives', true ) ) : // Allow monthly archives to not be displayed ?>
				<div class="sitemap-archives sitemap-monthly-archives monthly-archives archive-list">
					<h2 title="<?php esc_attr_e( 'Monthly Archives', 'simple-shop' ); ?>"><?php _e( 'Monthly Archives', 'simple-shop' ); ?></h2>
					<ul>
			...
			<?php if ( apply_filters( 'sds_sitemap_show_categories', true ) ) : // Allow categories to not be displayed ?>
				<div class="sitemap-categories category-list">
					<h2 title="<?php esc_attr_e( 'Blog Categories', 'simple-shop' ); ?>"><?php _e( 'Blog Categories', 'simple-shop' ); ?></h2>
					<ul>
...
if ( ! function_exists( 'sds_archive_title' ) ) {
	function sds_archive_title() {
		...
		// Otherwise use fallback functionality TODO: Remove
			...
			?>
				<h1 title="<?php esc_attr_e( 'Author Archive:', 'simple-shop' ); ?> <?php echo ( $author instanceof WP_User ) ? $author->display_name : false; ?>" class="page-title author-archive-title">
			...
			elseif ( is_category() ) :
			?>
				<h1 title="<?php single_cat_title( __( 'Category Archive: ', 'simple-shop' ) ); ?>" class="page-title category-archive-title">
			...
			elseif ( is_tag() ) :
			?>
				<h1 title="<?php single_tag_title( __( 'Tag Archive: ', 'simple-shop' ) ); ?>" class="page-title tag-archive-title">
			...
			?>
				<h1 title="<?php esc_attr_e( 'Daily Archives:', 'simple-shop' ); ?> <?php echo $the_date; ?>" class="page-title day-archive-title daily-archive-title">
			...
			?>
				<h1 title="<?php esc_attr_e( 'Monthly Archives:', 'simple-shop' ); ?> <?php echo $the_date; ?>" class="page-title month-archive-title monthly-archive-title">
			...
			?>
				<h1 title="<?php esc_attr_e( 'Yearly Archives:', 'simple-shop' ); ?> <?php echo $the_date; ?>" class="page-title year-archive-title yearly-archive-title">
...
if ( ! function_exists( 'sds_no_posts' ) ) {
	...
	?>
		<section class="no-results no-posts">
			<p><?php _e( 'We were not able to find any posts. Please try again.', 'simple-shop' ); ?></p>
		</section>
	<?php
	}
}
...
if ( ! function_exists( 'sds_copyright' ) ) {
	...
	?>
		<span class="site-copyright">
			<?php echo apply_filters( 'sds_copyright', sprintf( wp_kses( __( 'Copyright &copy; %1$s <a href="%2$s">%3$s</a>. All Rights Reserved.', 'simple-shop' ), array( 'a' => array( 'href' => array() ) ) ), date( 'Y' ), esc_url( home_url( '/' ) ), get_bloginfo( 'name' ) ) ); ?>
		</span>
...
if ( ! function_exists( 'sds_post_meta' ) ) {
	function sds_post_meta() {
		...
		?>
			...
			<?php
				printf( __( 'This entry was posted in %1$s and tagged in %2$s.', 'simple-shop' ),
		...
		?>
			...
			<?php
				printf( __( 'This entry was posted in %1$s.', 'simple-shop' ),
				get_the_category_list( ', ', 'single' ) );
			?>
			</p>
		<?php
		...
		?>
			...
			<?php
				printf( __( 'This entry was tagged in %1$s.', 'simple-shop' ),
				get_the_tag_list( '', ', ' ) );
			?>
			</p>
		<?php
...
if ( ! function_exists( 'sds_post_navigation' ) ) {
	function sds_post_navigation( $return = false ) {
		...
		$pagination_links = paginate_links( array(
			...
			'next_text' => __( 'Next &#8594;', 'simple-shop' ),
			'prev_text' => __( '&#8592; Previous', 'simple-shop' ),
			...
			<article id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
				<section class="comment-author vcard">
					<section class="author-details">
						...
						<header class="comment-meta">
							<cite class="fn">
								<?php
									printf( __( '<a href="%1$s"><time datetime="%2$s" itemprop="commentTime">%3$s</time></a>', 'simple-shop' ),
										esc_url( get_comment_link( $comment->comment_ID ) ),
										get_comment_time( 'c' ),
										sprintf( __( '%1$s at %2$s', 'simple-shop' ), get_comment_date(), get_comment_time() )
									);
								?>

								<?php edit_comment_link( __( 'Edit', 'simple-shop' ), '<span class="edit-link">', '<span>' ); ?>
							</cite>
						</header>
					</section>
				</section>
				...
				<section class="comment-content-container">
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'simple-shop' ); ?></p>
					<?php endif; ?>
				...
				<section class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'simple-shop' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</section>
			</article>
		</li>
		<?php
...
function sds_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Logo/Site Title & Tagline', 'simple-shop' );
	...
	$wp_customize->add_section( 'sds_theme_options_show_hide', array(
		...
		'title' => __( 'Show or Hide Tagline', 'simple-shop' ),
		'description' => __( 'Use this option to show or hide the tagline on your site.', 'simple-shop' )
	) );
	...
	if ( function_exists( 'sds_color_schemes' ) ) {
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Color_Scheme_Control(
				...
				'sds_theme_options[color_scheme]', // IDs can have nested array keys
				array(
					'label' => __( 'Color Scheme', 'simple-shop' ),
					'description' => __( 'Select a color scheme to use on your site.', 'simple-shop' ),
					'section'  => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'content_color',
			array(
				'label' => __( 'Content Color', 'simple-shop' ),
				'section' => 'colors',
	...
	if ( function_exists( 'sds_web_fonts' ) ) {
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Web_Font_Control(
				...
				'sds_theme_options[web_font]', // IDs can have nested array keys
				array(
					'label' => __( 'Web Fonts', 'simple-shop' ),
					'description' => __( 'Select a web font to use on your site.', 'simple-shop' ),
					'section'  => 'fonts',
	...
	if ( function_exists( 'sds_content_layouts' ) ) {
		...
		$wp_customize->add_section( 'sds_theme_options_content_layouts', array(
			...
			'title' => __( 'Content Layouts', 'simple-shop' ),
			'description' => __( 'Control the layout of the content on your site here. Choose a global layout scheme to be used across your entire site or specify individual content type layout schemes by adjusting the options below.', 'simple-shop' )
		) );
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][global]', // IDs can have nested array keys
				array(
					'label' => __( 'Global Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][front_page]', // IDs can have nested array keys
				array(
					'label' => __( 'Front Page Content Layout', 'simple-shop' ),
					'description' => __( 'Select a content layout that will be applied to the front page on your site (if selected in Settings &gt; Reading).', 'simple-shop' ),
					'section'  => 'sds_theme_options_content_layouts',
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][home]', // IDs can have nested array keys
				array(
					'label' => __( 'Home Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][single]', // IDs can have nested array keys
				array(
					'label' => __( 'Single Post Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][page]', // IDs can have nested array keys
				array(
					'label' => __( 'Single Page Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][archive]', // IDs can have nested array keys
				array(
					'label' => __( 'Archive Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][category]', // IDs can have nested array keys
				array(
					'label' => __( 'Category Archive Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][tag]', // IDs can have nested array keys
				array(
					'label' => __( 'Tag Archive Content Layout', 'simple-shop' ),
		...
		$wp_customize->add_control(
			new SDS_Theme_Options_Customize_Content_Layout_Control(
				...
				'sds_theme_options[content_layouts][404]', // IDs can have nested array keys
				array(
					'label' => __( '404 Error Content Layout', 'simple-shop' ),
					'description' => __( 'Select a content layout that will be applied to the 404 error page on your site. <strong>Please Note: The Customizer does not allow for previewing of 404 error pages.</strong>', 'simple-shop' ),
					'section'  => 'sds_theme_options_content_layouts',
	...
	$wp_customize->add_section( 'sds_theme_options_social_media', array(
		...
		'title' => __( 'Social Media', 'simple-shop' ),
		'description' => __( 'Enter your social media links here. This section is used throughout the site to display social media links to visitors. Some themes display social media links automatically, and some only display them within the Social Media widget.', 'simple-shop' )
	) );
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'sds_theme_options[social_media][instagram_url]', // IDs can have nested array keys
			array(
				'label' => __( 'Instagram', 'simple-shop' ),
				'section'  => 'sds_theme_options_social_media',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'sds_theme_options[social_media][pinterest_url]', // IDs can have nested array keys
			array(
				'label' => __( 'Pinterest', 'simple-shop' ),
				'section'  => 'sds_theme_options_social_media',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'sds_theme_options[social_media][foursquare_url]', // IDs can have nested array keys
			array(
				'label' => __( 'Foursquare', 'simple-shop' ),
				'section'  => 'sds_theme_options_social_media',
	...
	$wp_customize->add_control(
		new SDS_Theme_Options_Customize_Checkbox_Control(
			...
			'sds_theme_options[social_media][rss_url_use_site_feed]', // IDs can have nested array keys
			array(
				'label' => __( 'RSS - Use Site RSS Feed', 'simple-shop' ),
				'description' => __( 'When "yes" is displayed, the RSS feed for your site will be used. Otherwise, you can enter a custom RSS URL to use instead.', 'simple-shop' ),
				'section'  => 'sds_theme_options_social_media',
				...
				'checked_label' => __( 'Yes', 'simple-shop' ),
				'unchecked_label' => __( 'No', 'simple-shop' ),
				'style' => array(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'sds_theme_options[social_media][rss_url]', // IDs can have nested array keys
			array(
				'label' => __( 'RSS - Custom RSS Feed', 'simple-shop' ),
				'section'  => 'sds_theme_options_social_media',
...
function sds_after_setup_theme() {
	...
	register_nav_menus( array(
		'top_nav' => __( 'Top Navigation', 'simple-shop' ),
		'primary_nav' => __( 'Primary Navigation', 'simple-shop' ),
		'footer_nav' => __( 'Footer Navigation', 'simple-shop' )
	) );
}
...
function sds_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Primary Sidebar', 'simple-shop' ),
		'id'            => 'primary-sidebar',
		'description'   => __( 'This widget area is the primary widget area.', 'simple-shop' ),
	...
	// Secondary sidebar
	register_sidebar( array(
		'name'          => __( 'Secondary Sidebar', 'simple-shop' ),
		'id'            => 'secondary-sidebar',
		'description'   => __( 'This widget area is the secondary widget area.', 'simple-shop' ),
	...
	// Front Page Slider
	register_sidebar( array(
		'name'          => __( 'Front Page Slider', 'simple-shop' ),
		'id'            => 'front-page-slider-sidebar',
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings &gt; Reading in the Dashboard.* This widget area is displayed above the content on the Front Page.', 'simple-shop' ),
	...
	// Front Page
	register_sidebar( array(
		'name'          => __( 'Front Page', 'simple-shop' ),
		'id'            => 'front-page-sidebar',
		'description'   => __( '*This widget area is only displayed if a Front Page is selected via Settings &gt; Reading in the Dashboard.* This widget area is displayed below the Front Page Slider on the Front Page and will replace the Front Page content.', 'simple-shop' ),
	...
	register_sidebar( array(
		'name'          => __( 'Header Call To Action', 'simple-shop' ),
		'id'            => 'header-call-to-action-sidebar',
		'description'   => __( 'This widget area is used to display a call to action in the header.', 'simple-shop' ),
	...
	// After Posts
	register_sidebar( array(
		'name'          => __( 'After Posts', 'simple-shop' ),
		'id'            => 'after-posts-sidebar',
		'description'   => __( 'This widget area is displayed below the content on single posts only.', 'simple-shop' ),
	...
	// Footer
	register_sidebar( array(
		'name'          => __( 'Footer', 'simple-shop' ),
		'id'            => 'footer-sidebar',
		'description'   => __( 'This widget area is displayed in the footer of all pages.', 'simple-shop' ),
	...
	// Copyright
	register_sidebar( array(
		'name'          => __( 'Copyright Area', 'simple-shop' ),
		'id'            => 'copyright-area-sidebar',
		'description'   => __( 'This widget area is designed for small text blurbs or disclaimers at the bottom of the website.', 'simple-shop' ),
