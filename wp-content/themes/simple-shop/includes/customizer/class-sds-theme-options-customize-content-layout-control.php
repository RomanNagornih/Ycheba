	...
	?>
		<div class="customize-sds-theme-options-content-layout-wrap customize-sds-theme-options-content-layout-<?php echo esc_attr( $this->content_layout_id ); ?>-wrap">
			...
			?>
				...
				<span class="description"><?php  printf( _x( '%1$s', 'Content layout description; describes where the content layout will be applied', 'simple-shop' ), $this->description ); ?></span>
			<?php
				endif;
			?>
		</div>
