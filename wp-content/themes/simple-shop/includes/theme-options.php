...
if ( ! class_exists( 'SDS_Theme_Options' ) ) {
	...
	class SDS_Theme_Options {
		...
		function admin_enqueue_scripts( $hook ) {
			...
			// About Page
			if ( $hook === 'appearance_page_about-simple-shop' )
				// Font Awesome
		...
		function admin_menu() {
			// About
			add_theme_page( sprintf( __( 'About %1$s', 'simple-shop' ), $this->theme->get( 'Name' ) ), sprintf( __( 'About %1$s', 'simple-shop' ), $this->theme->get( 'Name' ) ), 'edit_theme_options', 'about-simple-shop', array( $this, 'sds_about_theme_page' ) );
		}
		...
		?>
			<div class="wrap about-wrap">
				<h1><?php printf( __( 'Welcome to %1$s', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></h1>
				<div class="about-text sds-about-text"><?php printf( __( 'Learn more about %1$s on this page.', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></div>

				<h3 class="nav-tab-wrapper sds-theme-options-nav-tab-wrapper sds-theme-options-tab-wrap">
					<a href="#getting-started" id="getting-started-tab" class="nav-tab sds-theme-options-tab nav-tab-active"><?php _e( 'Getting Started', 'simple-shop' ); ?></a>
					<a href="#free-vs-pro" id="free-vs-pro-tab" class="nav-tab sds-theme-options-tab"><?php _e( 'Free vs. Pro', 'simple-shop' ); ?></a>
				...
				<div id="sds-about-page">
					...
					<div id="getting-started-tab-content" class="sds-theme-options-tab-content sds-theme-options-tab-content-active">
						<div class="sds-about-page-section">
							<h3><?php printf( __( 'Welcome to %1$s', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></h3>
							<p><?php _e( 'Thanks for choosing Slocum Themes. We\'ve created this page to help guide you through setting up your website. We hope that you enjoy our themes.', 'simple-shop' ); ?></p>
						</div>

						<div class="sds-about-page-section">
							<h3><?php _e( 'Get Started in the Customizer', 'simple-shop' ); ?></h3>
							<p><?php printf( __( '%1$s utilizes the WordPress Customizer. This means that you can customize everything in one place! Visit the <a href="%2$s">Customizer</a> to get started.', 'simple-shop' ), $this->theme->get( 'Name' ), esc_url( wp_customize_url() ) ); ?></p>
							<p>
								<a href="<?php echo esc_url( wp_customize_url() ); ?>" class="button button-primary"><?php _e( 'Launch Customizer', 'simple-shop' ); ?></a>
							</p>
						</div>

						<div class="sds-about-page-section">
							<h3><?php _e( 'General Documentation', 'simple-shop' ); ?></h3>
							<p><?php printf( __( 'Be sure to have a look at our <a href="%1$s" target="_blank">General Documentation</a> for helpful guides.', 'simple-shop' ), esc_url( 'https://slocumthemes.com/docs/section/general/' ) ); ?></p>
						</div>

						<div class="sds-about-page-section">
							<h3><?php _e( 'Build the Perfect WordPress Website Course', 'simple-shop' ); ?></h3>
							<p><?php _e( 'We created free a 9-part course that will help you build the perfect WordPress website. We cover topics such as: security, lead generation, backups, and more.', 'simple-shop' ); ?></p>
							<p>
							<a href="<?php echo esc_url( 'https://slocumthemes.com/freecourse' ); ?>" class="button button-primary" target="_blank"><?php _e( 'Enroll in the free course', 'simple-shop' ); ?></a>
						</div>
					...
					<div id="free-vs-pro-tab-content" class="sds-theme-options-tab-content">
						<div class="sds-about-page-section">
							<h3><?php _e( 'Free vs. Pro', 'simple-shop' ); ?></h3>
							<p><?php printf( __( 'Use the table below to determine if the Pro version of %1$s is right for you.', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></p>

							<table class="sds-about-page-table free-vs-pro-table">
								<tr>
									<th></th>
									<th><?php echo $this->theme->get( 'Name' ); ?></th>
									<th><?php printf( __( '%1$s Pro', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></th>
								</tr>
								...
								<?php if ( function_exists( 'sds_color_schemes' ) || $pro_color_schemes_count > 0 ) : ?>
									<tr>
										<td class="sds-about-page-free-vs-pro-component">
											<h4><?php _e( 'Color Schemes', 'simple-shop' ); ?></h4>
											<p>
												<?php
													// Free and Pro color schemes
													if ( $free_color_schemes_count > 0 && $pro_color_schemes_count > 0 )
														printf( __( 'Both %1$s and %1$s Pro have color schemes.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Pro color schemes only
													else if ( $free_color_schemes_count === 0 && $pro_color_schemes_count > 0 )
														printf( __( '%1$s Pro has color schemes.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Free color schemes only
													else if ( $free_color_schemes_count > 0 && $pro_color_schemes_count === 0 )
														printf( __( '%1$s has color schemes.', 'simple-shop' ), $this->theme->get( 'Name' ) );

													// Free vs Pro color scheme count
													if ( $free_color_schemes_count < $pro_color_schemes_count )
														printf( __( ' %1$s Pro offers more color schemes for you to choose from.', 'simple-shop' ), $this->theme->get( 'Name' ) );
												?>
											</p>
										</td>
										<td class="sds-about-page-free-vs-pro-free-component">
											...
											<?php if ( $free_color_schemes_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Color Scheme', '%1$s Color Schemes', $free_color_schemes_count, 'simple-shop' ), $free_color_schemes_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Color Schemes', 'simple-shop' ); ?></span>
											<?php endif; ?>
										</td>
										<td class="sds-about-page-free-vs-pro-pro-component">
											...
											<?php if ( $pro_color_schemes_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Color Scheme', '%1$s Color Schemes', $pro_color_schemes_count, 'simple-shop' ), $pro_color_schemes_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Color Schemes', 'simple-shop' ); ?></span>
											<?php endif; ?>
								...
								<?php if ( function_exists( 'sds_web_fonts' ) || $pro_web_fonts_count > 0 ) : ?>
									<tr>
										<td class="sds-about-page-free-vs-pro-component">
											<h4><?php _e( 'Web Fonts', 'simple-shop' ); ?></h4>
											<p>
												<?php
													// Free and Pro web fonts
													if ( $free_web_fonts_count > 0 && $pro_web_fonts_count > 0 )
														printf( __( 'Both %1$s and %1$s Pro have web fonts.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Pro web fonts only
													else if ( $free_web_fonts_count === 0 && $pro_web_fonts_count > 0 )
														printf( __( '%1$s Pro has web fonts.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Free web fonts only
													else if ( $free_web_fonts_count > 0 && $pro_web_fonts_count === 0 )
														printf( __( '%1$s has web fonts.', 'simple-shop' ), $this->theme->get( 'Name' ) );

													// Free vs Pro web font count
													if ( $free_web_fonts_count < $pro_web_fonts_count )
														printf( __( ' %1$s Pro offers more web fonts for you to choose from.', 'simple-shop' ), $this->theme->get( 'Name' ) );
												?>
											</p>
										</td>
										<td class="sds-about-page-free-vs-pro-free-component">
											...
											<?php if ( $free_web_fonts_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Web Font', '%1$s Web Fonts', $free_web_fonts_count, 'simple-shop' ), $free_web_fonts_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Web Fonts', 'simple-shop' ); ?></span>
											<?php endif; ?>
										</td>
										<td class="sds-about-page-free-vs-pro-pro-component">
											...
											<?php if ( $pro_web_fonts_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Web Font', '%1$s Web Fonts', $pro_web_fonts_count, 'simple-shop' ), $pro_web_fonts_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Web Fonts', 'simple-shop' ); ?></span>
											<?php endif; ?>
								...
								<?php if ( function_exists( 'sds_content_layouts' ) || $pro_content_layouts_count > 0 ) : ?>
									<tr>
										<td class="sds-about-page-free-vs-pro-component">
											<h4><?php _e( 'Content Layouts', 'simple-shop' ); ?></h4>
											<p>
												<?php
													// Free and Pro content layouts
													if ( $free_content_layouts_count > 0 && $pro_content_layouts_count > 0 )
														printf( __( 'Both %1$s and %1$s Pro have content layouts.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Pro content layouts only
													else if ( $free_content_layouts_count === 0 && $pro_content_layouts_count > 0 )
														printf( __( '%1$s Pro has content layouts.', 'simple-shop' ), $this->theme->get( 'Name' ) );
													// Free content layouts only
													else if ( $free_content_layouts_count > 0 && $pro_content_layouts_count === 0 )
														printf( __( '%1$s has content layouts.', 'simple-shop' ), $this->theme->get( 'Name' ) );

													// Free vs Pro content layout count
													if ( $free_content_layouts_count < $pro_content_layouts_count )
														printf( __( ' %1$s Pro offers more content layouts for you to choose from.', 'simple-shop' ), $this->theme->get( 'Name' ) );
												?>
											</p>
										</td>
										<td class="sds-about-page-free-vs-pro-free-component">
											...
											<?php if ( $free_content_layouts_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Content Layout', '%1$s Content Layouts', $free_content_layouts_count, 'simple-shop' ), $free_content_layouts_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Content Layouts', 'simple-shop' ); ?></span>
											<?php endif; ?>
										</td>
										<td class="sds-about-page-free-vs-pro-pro-component">
											...
											<?php if ( $pro_content_layouts_count > 0 ) : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php printf( _n( '%1$s Content Layout', '%1$s Content Layouts', $pro_content_layouts_count, 'simple-shop' ), $pro_content_layouts_count ); ?></span>
											<?php else : ?>
												<br />
												<span class="sds-about-page-free-vs-pro-desc"><?php _e( 'No Content Layouts', 'simple-shop' ); ?></span>
											<?php endif; ?>
								...
								<tr>
									<td class="sds-about-page-free-vs-pro-component">
										<h4><?php _e( 'Priority Support', 'simple-shop' ); ?></h4>
										<p><?php printf( __( 'Get priority helpdesk support by upgrading to %1$s Pro.', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></p>
									</td>
									<td class="sds-about-page-free-vs-pro-free-component">
								...
								<tr>
									<td class="sds-about-page-free-vs-pro-component">
										<h4><?php _e( 'Footer Copyright &amp; Branding', 'simple-shop' ); ?></h4>
										<p><?php _e( 'Adjust footer copyright &amp branding messages in the Customizer.', 'simple-shop' ); ?></p>
									</td>
									<td class="sds-about-page-free-vs-pro-free-component">
										<span class="fa fa-times"></span>
									</td>
								...
								<tr>
									<td class="sds-about-page-free-vs-pro-component">
										<h4><?php _e( 'Custom Scripts and Styles', 'simple-shop' ); ?></h4>
										<p><?php _e( 'Add custom scripts and custom CSS styles to your site.', 'simple-shop' ); ?></p>
									</td>
									<td class="sds-about-page-free-vs-pro-free-component">
										<span class="fa fa-times"></span>
									</td>
						...
						<div class="sds-about-page-section sds-about-page-section-free-vs-pro-upgrade sds-about-page-section-center">
							<p>
								<a href="<?php echo esc_url( ( function_exists( 'sds_get_pro_link' ) ) ? sds_get_pro_link( 'free-vs-pro-upgrade' ) : 'https://slocumthemes.com/' ); ?>" class="button button-primary" target="_blank"><?php printf( __( 'Upgrade to %1$s Pro!', 'simple-shop' ), $this->theme->get( 'Name' ) ); ?></a>
							</p>
						</div>
				...
				<div id="sds-theme-options-ads" class="sidebar">
					...
					<div class="sds-theme-options-ad">
						<div class="slocum-themes">
							<?php printf( __( 'Brought to you by <a href="%1$s" target="_blank">Slocum Themes</a>', 'simple-shop' ), 'http://slocumthemes.com/' ); ?>
						</div>
					</div>
				</div>
			</div>
